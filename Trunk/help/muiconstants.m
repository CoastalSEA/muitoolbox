...
% The following are helds as a default set of constant properties: <br>
% *y2s* - factor to convert years to seconds (365.2425 days). <br>
% *Gravity* - acceleration due to gravity (m/s2). Default is 9.81. <br>
% *WaterDensity* - density of water (kg/m3). Default is 1025. <br>
% *SedimentDensity* - density of sediment (kg/m3). Default is 2650.  <br>
