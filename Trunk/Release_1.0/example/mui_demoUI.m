classdef mui_demoUI < muiModelUI                         % << Edit to classname
%
%-------class help---------------------------------------------------------
% NAME
%   mui_demoUI.m
...
% 
    properties  (Access = protected)
        ...
        vNumber = '1.0'
        vDate   = 'Apr 2021'
        modelName = 'mui_demoUI'                                 % << Edit to application name
    ...
    methods (Static)
        function obj = mui_demoUI                                % << Edit to classname
...
%--------------------------------------------------------------------------  
    methods (Access = protected)
        function obj = setMUI(obj)
            ...
            obj.ModelInputs.Model_template = {'mui_demoModel'};
...
%%
        function props = setTabProperties(~)
            ...
            props = {...                                     % << Add additional inputs and adjust layout
                'mui_demoPropsInput','Inputs',[0.95,0.48],{180,60},'Input parameters:'};
        end    
 %%
        ...
        function setupMenuOptions(obj,src,~)
            ...
            switch src.Text
                ...
                case 'Input Parameters'                       % << Edit to call Parameter Input class
                    mui_demoPropsInput.setInput(obj);  
